...
leftImg8bit_source_folder = os.path.join(
    cityscapes, "leftImg8bit_trainvaltest", "leftImg8bit"
)
...
trainset = CustomClass(
    cityscapes, split="train", mode="fine", target_type="semantic", transforms=transform
)
validset = CustomClass(
    cityscapes, split="val", mode="fine", target_type="semantic", transforms=transform
)
